function getRanking() {
    ...
    var endpoint = "https://sheets.googleapis.com/v4/spreadsheets/1dzbcLzJlxPBLIKuP7BDI0xFqm3Wy-jozFHbIeY7T8bU/values/2024!G3:N12?key=AIzaSyBdJupU1WrSW8B0dhIxVi-PqLtFZDkGFFY";
    ...
    .then((data) => {
      ...
      data['values'].forEach(element => {
        if (element[1] != '#N/A') {
            ...
            output+= Math.abs(balance).toFixed(2) + '</h2></div><h1>';
      ...
      if (year == null) {
        document.getElementById('ano').innerHTML = "RANKING 2024";
      } else {
