function getRanking() {
    ...
    var endpoint = "https://sheets.googleapis.com/v4/spreadsheets/1dzbcLzJlxPBLIKuP7BDI0xFqm3Wy-jozFHbIeY7T8bU/values/2025!G3:N12?key=AIzaSyBdJupU1WrSW8B0dhIxVi-PqLtFZDkGFFY";
    ...
    .then((data) => {
      ...
      if (year == null) {
        document.getElementById('ano').innerHTML = "RANKING 2025";
      } else {
